...
| **Pocket Sheets**<br>`saltybananaslug-pocket-sheets` | Gives selected players a fast, phone-native, character-sheet-only interface with live checks, saves, reliable native attack rolls, damage, spells, features, inventory, containers, effects, death saves, resource tracking, and a player-safe read-only chat history—without maps, targeting, or drag-and-drop. | D&D5e 5.x. Foundry v13. GM-controlled per player. |
